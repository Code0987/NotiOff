 ...
 */
export declare function getTaskToPublish(cwd: string, env: NodeJS.ProcessEnv): Promise<string>;
/**
 * @param {string} cwd the path of current working directory
...
export declare function publishArtifact(cwd: string, env: NodeJS.ProcessEnv): Promise<{}>;
